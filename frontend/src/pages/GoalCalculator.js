            ...
            <Header />
                ...
                >
                    ...
                    <div className="flex justify-center">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold text-white mobile_ft">Goal Calculator</h2>
                         <div className="my-6 mobile_mb-0"></div>
                        <a
                            href="/"
                            className=" text-lg inline-flex items-center gap-2 hover:text-white text-white"
                        >
                            Home <i className="fa-solid fa-angle-right"></i> <span className="">Goal Calculator</span>
                        </a>
                        </div>
                    </div>
                    </div>
...
export default GoalCalculators;